...
// src/Command/QueueExportHTMLCommand.php
...
class QueueExportHTMLCommand extends Command
{
    ...
    protected function configure()
    {
        ...
        // the "--help" option
        ->setHelp('Exports games that have been already processed by evaluator into HTML files for upload to the cache.')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
      ...
      if( $gid != -1) {
        ...
        // Request HTML files update for the game
        $this->gameManager->exportHTMLFile( $gid, $depths);
